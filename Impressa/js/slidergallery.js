(function($) {
    $.fn.simpleSlider = function(params) {
        ...
        if (params.navigation == false) params.styleNav = false;
        $('#slider-title').html('Nuestras Instalaciones');
        // add some css
        $(this).css({
            "position": "relative",
            "overflow": "hidden",
        ...
        if (params.navigation == true) {
            // create navs
            $(this).append('<div id="navigation"><span class="slider-nav prev"> <i class="fa fa-arrow-right" aria-hidden="true"></i></span> <span class="slider-nav next"> <i class="fa fa-arrow-left" aria-hidden="true"></i></span></div>');
        ...
        if (params.navigation == true) {
            $(this).find(".prev").on("click", function() {
                ...
                if (pix >= 11700) {
                    $('#slider-title').html('Algunas Ideas');
                } else {
                    $('#slider-title').html('Nuestras Instalaciones');
                }
            });
