$.fn.ycp = function(m, n, p, o) {
    ...
    function ycp_list(f, g, k, l) {
        $.ajax({
            ...
            var d = '';
            d += '<div class="vid-top">';
            d += '<span class="tombol vid-prev" title="Previous videos">Previo</span> ';
            d += '<span class="tombol vid-next" title="Next videos">Siguiente</span></div><div class="vid-bottom">';
            $.each(c.items, function(i, a) {
                ...
                d += '<div class="title-youtube">' + c.items[i].snippet.title + '</div><span class="mute by' + i + '"></span><br><span class="mute views' + i + '"></span> <span class="mute">-</span> <span class="mute date' + i + '"></span></div>'
            });
            d += '</div>';
